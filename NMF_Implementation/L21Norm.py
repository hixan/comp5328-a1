...
class Algorithm(Implementation):
    ...
    def __init__(self, components, stop_threshold=0.01, max_iter=100,
    ...
    def fit(self, X: np.ndarray, initial_representation=None):
        ...
        # fit the data
        # *2 to account for alternation
        for iteration in range(self._metavalues['max_iter'] * 2):
        ...
        # ../papers/Robust Nonnegative Matrix Factorization using L21 Norm 2011.pdf
            ...
            if optim == 'R':  # The flag will be R as it is switched above
